...
if [[ ! -z $(uname -r | grep gentoo) ]]; then
   [ "$(tty)" = "/dev/tty1" ] && ! pidof -s Hyprland > /dev/null 2>&1 && /home/cody/dotfiles/gentoo/setup.sh && /home/cody/.config/hypr/hypr-init.sh && gentoo-pipewire-launcher
   /home/cody/bin/swww init
else
